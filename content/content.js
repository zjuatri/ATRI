...
// 检查当前页面域名
if (window.location.href.includes('studywisdomh5.zhihuishu.com')) {
  console.log('智慧树页面检测成功:', window.location.href);
  
  // 如果是考试页面，检测所有 input 组件并提取URL参数
  if (window.location.href.includes('https://studywisdomh5.zhihuishu.com/exam')) {
    ...
    const urlObserver = new MutationObserver(() => {
      ...
      if (currentUrl !== lastUrl) {
        ...
        lastUrl = currentUrl;
        if (currentUrl.includes('https://studywisdomh5.zhihuishu.com/exam')) {
          // 重新提取参数
          extractExamParams();
        ...
        } else if (currentUrl.includes('https://studywisdomh5.zhihuishu.com/pointOfMastery')) {
        ...
        } else if (currentUrl.includes('https://studywisdomh5.zhihuishu.com/examAnalysis')) {
    ...
    window.addEventListener('popstate', () => {
      ...
      if (currentUrl.includes('https://studywisdomh5.zhihuishu.com/exam')) {
        extractExamParams();
      } else if (currentUrl.includes('https://studywisdomh5.zhihuishu.com/pointOfMastery') && isAutoAnswering) {
        setTimeout(() => {
          handlePointOfMasteryPage();
        }, 2000);
      } else if (currentUrl.includes('https://studywisdomh5.zhihuishu.com/examAnalysis') && isAutoAnswering) {
...
(async function restoreAutoAnsweringState() {
  try {
    ...
    if (result.isAutoAnswering) {
      ...
      // 如果是考试页面，等待题目数据加载
      if (window.location.href.includes('/exam') && !window.location.href.includes('/pointOfMastery') && !window.location.href.includes('/examAnalysis')) {
...
function findTargetButton() {
  // 只在 mastery 页面才查找按钮
  if (!window.location.href.includes('https://studywisdomh5.zhihuishu.com/study/mastery')) {
    return null;
  }
...
function startButtonMonitor() {
  ...
  const isMasteryPage = window.location.href.includes('https://studywisdomh5.zhihuishu.com/study/mastery');
...
function updateDisplayBoxContent() {
  ...
  const isStudyPage = window.location.href.includes('https://studywisdomh5.zhihuishu.com/study');
  const isMasteryPage = window.location.href.includes('https://studywisdomh5.zhihuishu.com/study/mastery');
  ...
  const isExamPage = window.location.href.includes('https://studywisdomh5.zhihuishu.com/exam');
...
function handlePointOfMasteryPage() {
  ...
  if (!currentUrl.includes('https://studywisdomh5.zhihuishu.com/pointOfMastery')) {
